...
import { Upload, X, Download, Presentation } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">PowerPoint to PDF</h1>
            </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              ...
              >
                ...
                <p className="text-lg font-medium mb-2">Drop your PowerPoint files here</p>
