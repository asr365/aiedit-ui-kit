      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          const splitFiles = files.flatMap(file => [
            { name: `${file.name.replace('.pdf', '')}_left_pages.pdf`, url: '#' },
            { name: `${file.name.replace('.pdf', '')}_right_pages.pdf`, url: '#' }
          ]);
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Split in Half</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Split two-page layouts into separate pages
            </p>
          </div>
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    {isProcessing ? "Splitting..." : "Split in Half"}
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Splitting PDF in half...</CardTitle>
              </CardHeader>
              <CardContent>
