    ...
    const interval = setInterval(() => {
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResult({
            name: "mixed_documents_alternating.pdf",
            url: '#'
          });
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Alternate & Mix</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Mix pages from multiple documents alternately
            </p>
          </div>
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    {isProcessing ? "Mixing..." : "Alternate & Mix"}
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Mixing documents alternately...</CardTitle>
              </CardHeader>
              <CardContent>
