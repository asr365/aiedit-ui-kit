...
import { Upload, X, Download, FileText, RotateCw } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_deskewed.pdf`,
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Deskew PDF</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Straighten scanned PDF documents automatically
            </p>
          </div>
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    {isProcessing ? "Processing..." : "Deskew PDF"}
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Straightening pages...</CardTitle>
              </CardHeader>
              <CardContent>
