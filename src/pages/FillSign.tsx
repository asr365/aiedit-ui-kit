      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_filled_signed.pdf`,
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Fill & Sign</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Fill out forms and add signatures easily
            </p>
          </div>
          ...
          {files.length > 0 && (
            <Card className="mb-8">
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  <Button 
                    onClick={handleFillSign} 
                    disabled={isProcessing}
                    className="w-full"
                    size="lg"
                  >
                    <FileEdit className="h-4 w-4 mr-2" />
                    {isProcessing ? "Processing..." : "Fill & Sign"}
                  </Button>
                </div>
              </CardContent>
            </Card>
