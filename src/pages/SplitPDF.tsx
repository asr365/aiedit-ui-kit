...
import { Upload, Split, Download, File, X, Loader2 } from "lucide-react";
...
const SplitPDF = () => {
    ...
    const interval = setInterval(() => {
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => `${file.name.replace('.pdf', '')}_split.pdf`));
          return 100;
        }
        return prev + 10;
      });
  ...
  const downloadAll = () => {
    // Simulate download
    console.log('Downloading split files...');
  };
      ...
      <div className="container mx-auto px-4 pt-24 pb-12">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            Separate PDF pages into individual files. Extract specific pages or split at defined intervals.
          </p>
        </div>
