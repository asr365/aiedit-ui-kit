...
import { Upload, X, Download, FileText, MessageSquare, Sparkles } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_questions.pdf`,
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Generate questions from document content automatically
            </p>
          </div>
