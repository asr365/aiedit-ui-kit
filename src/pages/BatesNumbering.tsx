...
import { Upload, X, Download, FileText, Hash } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="p-3 bg-fuchsia-100 dark:bg-fuchsia-900/20 rounded-xl">
                <Hash className="h-8 w-8 text-fuchsia-600" />
              </div>
              <h1 className="text-4xl font-bold">Bates Numbering</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Add sequential identification numbers to legal documents
            </p>
          </div>
                ...
                <CardContent>
                    ...
                    {files.map((file, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                        <div className="flex items-center gap-3">
                          <div className="p-2 bg-fuchsia-100 dark:bg-fuchsia-900/20 rounded">
                  ...
                  <div className="mt-6">
                    ...
                    >
                      ...
                      {isProcessing ? "Applying..." : "Apply Bates Numbering"}
                    </Button>
                  </div>
                </CardContent>
              </Card>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Applying Bates numbers...</CardTitle>
              </CardHeader>
              <CardContent>
