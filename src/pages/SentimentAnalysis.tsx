...
import { Upload, X, Download, FileText, BarChart3, Sparkles } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_sentiment_analysis.pdf`,
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Document Sentiment Analysis</h1>
            ...
            <p className="text-muted-foreground text-lg">
              Analyze tone and sentiment of business documents
            </p>
          </div>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Analyzing sentiment...</CardTitle>
              </CardHeader>
              <CardContent>
