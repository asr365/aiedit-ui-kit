      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace(/\.[^/.]+$/, '')}_scanned.pdf`,
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">PDF Scanner</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Scan images and documents to high-quality PDFs
            </p>
          </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              ...
              >
                ...
                <p className="text-muted-foreground mb-4">Supports images and PDF files</p>
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    {isProcessing ? "Scanning..." : "Scan to PDF"}
                  </Button>
                </div>
              </CardContent>
            </Card>
