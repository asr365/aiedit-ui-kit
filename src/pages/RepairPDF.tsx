...
import { Upload, X, Download, FileText, Wrench } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_repaired.pdf`,
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Repair PDF</h1>
            </div>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Repairing PDF files...</CardTitle>
              </CardHeader>
              <CardContent>
