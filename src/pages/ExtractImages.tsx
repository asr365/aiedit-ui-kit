...
const ExtractImages = () => {
  ...
  const [results, setResults] = useState<Array<{ name: string; url: string; count: number }>>([]);
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Extract Images</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Extract all images from your PDF documents
            </p>
          </div>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Extracting images...</CardTitle>
              </CardHeader>
              <CardContent>
