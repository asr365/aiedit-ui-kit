...
import { Upload, X, Download, FileText, FileEdit, Sparkles } from "lucide-react";
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Smart Form Auto-Fill</h1>
            ...
            <p className="text-muted-foreground text-lg">
              Automatically detect and fill form fields intelligently
            </p>
          </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              ...
              >
                ...
                <p className="text-lg font-medium mb-2">Drop your PDF forms here</p>
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    {isProcessing ? "Auto-Filling..." : "Auto-Fill Forms"}
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Auto-filling forms...</CardTitle>
              </CardHeader>
              <CardContent>
