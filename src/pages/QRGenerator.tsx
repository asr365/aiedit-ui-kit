...
import { Upload, X, Download, FileText, QrCode } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_with_qr.pdf`,
            url: '#'
          })));
          return 100;
        }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          ...
          {files.length > 0 && (
            <>
              <Card className="mb-8">
                ...
                <CardContent>
                  <Label htmlFor="qrContent">Text or URL for QR Code</Label>
                  <Input
                    id="qrContent"
                    value={qrContent}
                ...
                <CardContent>
                    ...
                    {files.map((file, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                        <div className="flex items-center gap-3">
                          <div className="p-2 bg-gray-100 dark:bg-gray-900/20 rounded">
                  ...
                  <div className="mt-6">
                    <Button 
                      ...
                      disabled={isProcessing || !qrContent}
                      className="w-full"
                      size="lg"
                    >
                      <QrCode className="h-4 w-4 mr-2" />
                      {isProcessing ? "Generating..." : "Add QR Code"}
                    </Button>
                  </div>
                </CardContent>
              </Card>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Adding QR codes...</CardTitle>
              </CardHeader>
              <CardContent>
