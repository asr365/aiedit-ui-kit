...
import { Upload, X, Download, FileText, Grid } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_${layout}up.pdf`,
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">N-up Printing</h1>
            </div>
          ...
          {files.length > 0 && (
            <>
              <Card className="mb-8">
                ...
                <CardContent>
                  <Label htmlFor="layout">Pages per sheet</Label>
                    ...
                    {files.map((file, index) => (
                      <div key={index} className="flex items-center justify-between p-3 bg-muted rounded-lg">
                        <div className="flex items-center gap-3">
                          <div className="p-2 bg-rose-100 dark:bg-rose-900/20 rounded">
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Applying layout...</CardTitle>
              </CardHeader>
              <CardContent>
