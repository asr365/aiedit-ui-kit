      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: file.name.replace(/\.(xlsx|xls)$/, '.pdf'),
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Excel to PDF</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Convert Excel spreadsheets to PDF documents while preserving formatting
            </p>
          </div>
          ...
          <Card className="mb-8">
            ...
            <CardContent>
              ...
              >
                ...
                <p className="text-lg font-medium mb-2">Drop your Excel files here</p>
