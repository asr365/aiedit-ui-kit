...
import { Upload, X, Download, FileText, Bookmark } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_bookmarked.pdf`,
            url: '#'
          })));
          return 100;
        }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              ...
              <h1 className="text-4xl font-bold">Create Bookmarks</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Add navigation bookmarks to your PDF documents
            </p>
          </div>
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    {isProcessing ? "Creating..." : "Create Bookmarks"}
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Creating bookmarks...</CardTitle>
              </CardHeader>
              <CardContent>
