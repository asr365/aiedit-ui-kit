...
import { Upload, X, Download, FileText, FileEdit } from "lucide-react";
      ...
      setProgress(prev => {
        if (prev >= 100) {
          ...
          setResults(files.map(file => ({
            name: `${file.name.replace('.pdf', '')}_fillable.pdf`,
            url: '#'
          })));
          return 100;
        }
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <div className="flex items-center justify-center gap-3 mb-4">
              <div className="p-3 bg-cyan-100 dark:bg-cyan-900/20 rounded-xl">
                <FileEdit className="h-8 w-8 text-cyan-600" />
              </div>
              <h1 className="text-4xl font-bold">Create Forms</h1>
            </div>
            <p className="text-muted-foreground text-lg">
              Make existing PDFs fillable with form fields
            </p>
          </div>
              ...
              <CardContent>
                ...
                <div className="mt-6">
                  ...
                  >
                    ...
                    {isProcessing ? "Creating..." : "Create Fillable Forms"}
                  </Button>
                </div>
              </CardContent>
            </Card>
          ...
          {isProcessing && (
            <Card className="mb-8">
              <CardHeader>
                <CardTitle>Creating fillable forms...</CardTitle>
              </CardHeader>
              <CardContent>
